...
from .modeling_llama_kv import medusa_status
from .utils import *
...
class ResBlock(nn.Module):
    ...
    def forward(self, x):
        ...
        """
        #print("dev: ", self.linear.weight.device, x.device)
        return x.to(self.linear.weight.device) + self.act(self.linear(x.to(self.linear.weight.device)))
...
class MedusaModel(nn.Module):
    ...
    def medusa_generate(
        ...
        for idx in range(max_steps):
            ...
            #print("position: ", medusa_buffers["medusa_position_ids"])
